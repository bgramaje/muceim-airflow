...
with DAG(
    ...
    description="Gold layer Question 1 report generation - Typical Day analysis. Automatically triggered when Gold Tables completes. Can also be manually triggered with parameters",
    params={
        "start": Param(
            type=["string", "null"],
            default=None,
