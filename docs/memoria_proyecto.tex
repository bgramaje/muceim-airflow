...
# 1. Obtener URLs a procesar (solo las fechas faltantes) en una única task
...
# 2. Procesar cada URL en paralelo (Dynamic Task Mapping)
od_process = (
    ...
    .expand(url=od_urls)  # Expande a N tareas
)
\end{lstlisting}
